...
app.get('/', (req, res, next) => res.render("index", { unregistered: req.session.unregistered, user: req.session.user, error: req.session.err, data: getCountries()})).catch((err)=>res.status(500).send(err))
